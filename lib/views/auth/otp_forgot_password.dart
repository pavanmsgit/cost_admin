...
class OtpScreenForgotPassword extends StatelessWidget {
  OtpScreenForgotPassword({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Spinner(
      child: Scaffold(
        ...
        body: SafeArea(
          child:Form(
            key: phoneAuthController.otpForgotPasswordKey,
              ...
              slivers: [
                ...
                SliverToBoxAdapter(child:  Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          CostButton(
                            buttonText: 'CONTINUE',
                            onTap: () => phoneAuthController.verifyOtpAtOtpPageForgotPassword(context),
                          ),
                        ],
                      ),
                    ),
                    ...
                    TextButton(
                      onPressed: () async {
                        await phoneAuthController.sendOtpForgotPassword();
                      },
                      child: RichText(
                        text:  TextSpan(
                          children: [
